        ...
        rg.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                switch (radioGroup.indexOfChild(findViewById(i))) {
                    case 0:
                        Toast.makeText(getApplicationContext(), R.string.msg_change1, Toast.LENGTH_LONG).show();
                        break;
                    case 1:
                        Toast.makeText(getApplicationContext(), R.string.msg_change2, Toast.LENGTH_LONG).show();
                        break;
                }
            }
        });
